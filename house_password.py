...
def checkio(data):
    ...
    if (data.__len__() < 10) :
        ...
        if re.search ( digit_pattern, data) :
             ...
             has_digit = 0
    if (more_than_ten_symbols & has_digit & has_lower_case & has_lower_case): # basically now we can tell where is the problem, I HATE ERROR MESSAGE "INCORRECT PASSWORD OR LOGIN OR CATPTCHA"
